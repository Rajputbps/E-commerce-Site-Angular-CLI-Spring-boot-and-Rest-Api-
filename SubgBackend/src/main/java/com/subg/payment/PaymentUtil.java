...
public class PaymentUtil {
    ...
    private static final String paymentSalt = "Your Key";

    private static final String sUrl = "http://localhost:8080/api/payment-response";//put your url

    private static final String fUrl = "http://localhost:8080/api/payment-response";//put your url
